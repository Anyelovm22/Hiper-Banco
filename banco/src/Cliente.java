...
//    public int[][] generarTarjetaAcceso() {
//        int[][] tarjeta = new int[4][5];
//        // Generate random values for the tarjetaAcceso
//        // (assuming the values should be between 10 and 99)
//        for (int i = 0; i < tarjeta.length; i++) {
//            for (int j = 0; j < tarjeta[i].length; j++) {
//                tarjeta[i][j] = new Random().nextInt(90) + 10;
//            }
//        }
//        return tarjeta;
//    }
